...
public class My_First_GUI_Lambda_EASY extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Lambda Expression
        b.setOnAction((ActionEvent event) -> { //Lambda Expression
        ...
        // Lambda Expression
        cb.setOnAction((ActionEvent event) -> { // Lambda Expression
