...
public class Sponge_Bob_Buttons_2 extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Text object for the title
          Text title = new Text(30, 30, "Sponge Bob Buttons");
      title.setFont(Font.font("Comic Sans MS", FontWeight.EXTRA_BOLD,
        ...
        b5_1.setGraphic(new ImageView(krabs));
        
        Button b5_2 = new Button();
        b5_2.setGraphic(new ImageView(krabs));
        ...
        //Add the VBox to the pane for add title
        vb.setAlignment(Pos.CENTER);
        vb.getChildren().addAll(title, b4);
        pane.setTop(vb); // Add title "Sponge Bob Buttons"
